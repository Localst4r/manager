...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (success) {
      const stolen = Math.floor(targetBalance * (0.1 + Math.random() * 0.2));
      ...
      embed.setTitle('robbery successful!')
        ...
        .setColor(0x57f287)
        .addFields({ name: 'ðŸ’° Your Balance', value: `${economy.getBalance(interaction.user.id).toLocaleString()} coins`, inline: true });
    } else {
