  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'ðŸŽ Streak Bonus', value: `+${result.bonus} coins`, inline: true },
        { name: 'ðŸ’° New Balance', value: `${economy.getBalance(interaction.user.id).toLocaleString()} coins`, inline: true }
      )
